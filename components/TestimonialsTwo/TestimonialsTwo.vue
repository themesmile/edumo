  ...
  <div class="testimonial-wrap">
    ...
    <v-row class="d-flex align-center pt-12 ">
      <v-col cols="12" sm="12" md="12" lg="4">
        <h2 class="font-weight-medium display-1 font-weight-bold mb-3 font-weight-bold text-left mb-4 px-10">
          Because crypto is for <br>everyone.
        </h2>
        <p class="body-1 text-left mt-4 mb-16 px-10">
          We believe that crypto is for everyone. See what they say about us.
        </p>
        ...
        <div class="carousel" v-if="loaded">
          <slick ref="slick" :options="slickOptions">
            <div v-for="(item, index) in testiContent" :key="index" class="item ">
              <testi-card :text="item.text" :avatar="item.avatar" :name="item.name" />
            </div>
          </slick>
        </div>
      </v-col>
