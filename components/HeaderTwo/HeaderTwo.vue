  ...
  <div>
    ...
    <v-app-bar v-scroll="handleScroll" :class="{ fixed: fixed }" class="header" fixed app height="auto">
      ...
      <div class="header-content">
        <nav class="nav-menu">
          ...
          <div v-if="loaded" class="d-flex justify-center">
            <scrollactive v-if="isDesktop" :offset="navOffset" active-class="active" tag="div">
              ...
              <v-btn v-for="item in MainItems" :key="item.title"
                class="anchor-link scrollactive-item overline font-weight-bold px-4" text rounded :to="item.link">
                {{ item.title }}
              </v-btn>
        ...
        <nav class="user-menu ">
          <v-btn rounded depressed v-if="isDesktop" text
            class="anchor-link scrollactive-item overline font-weight-bold px-4 d-none d-sm-flex" to="/login">
            Login
          </v-btn>
           <ConnectWallet />
          <setting-menu />
